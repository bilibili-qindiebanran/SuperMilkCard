...
static const char *TAG = "st77926_tp";
...
esp_err_t esp_lcd_touch_st77926_get_info(esp_lcd_touch_handle_t tp, esp_lcd_touch_st77926_info_t *info)
{
    ...
    info->chip_id = st77926->chip_id;
    info->fw_version = st77926->fw_version;
    info->x_res = st77926->x_res;
    info->y_res = st77926->y_res;
    info->max_touches = st77926->max_touches;
    return ESP_OK;
}
